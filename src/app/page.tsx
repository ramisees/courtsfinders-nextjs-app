    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-black text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Search Box */}
          <div id="search" className="bg-white/10 backdrop-blur-sm p-6 rounded-lg max-w-4xl mx-auto">
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4 mb-4">
              ...
              <select 
                ...
                className="px-4 py-3 bg-white border border-gray-300 rounded text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-base"
              >
              ...
              <button
                type="submit"
                className="px-8 py-3 bg-yellow-400 text-black rounded hover:bg-yellow-300 transition-colors font-bold text-base whitespace-nowrap"
              >
                Find Courts
              </button>
            </form>
      ...
      {/* Sports Categories */}
      <section className={`py-20 ${hasSearched ? 'bg-white' : 'bg-gray-100'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 text-center shadow-lg hover:shadow-xl transition-shadow">
              ...
              <Link href="/courts/tennis" className="inline-block bg-yellow-400 text-black px-6 py-3 rounded hover:bg-yellow-300 transition-colors font-bold">
                Explore
              </Link>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 text-center shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Basketball Courts</h3>
              <p className="text-gray-600 mb-6">
                Discover indoor and outdoor basketball courts for casual or competitive play.
              </p>
              <Link href="/courts/basketball" className="inline-block bg-yellow-400 text-black px-6 py-3 rounded hover:bg-yellow-300 transition-colors font-bold">
                Explore
              </Link>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 text-center shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Multi-Sport Facilities</h3>
              <p className="text-gray-600 mb-6">
                Access comprehensive sports complexes with equipment rental and coaching.
              </p>
              <Link href="/courts/multi-sport" className="inline-block bg-yellow-400 text-black px-6 py-3 rounded hover:bg-yellow-300 transition-colors font-bold">
                Explore
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Enter your location to find courts near you</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Compare</h3>
              <p className="text-gray-600">Browse facilities, check availability and prices</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Play</h3>
              <p className="text-gray-600">Find and secure your court time</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Play</h3>
              <p className="text-gray-600">Enjoy your game at your chosen facility</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-black text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <Image
                ...
                style={{ height: '192px', width: 'auto' }}
              />
              <p className="text-gray-400">Making sports accessible to everyone since 2024.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-2">Email: info@courtsfinder.com</p>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">&copy; 2024 Courts Finder. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
